...
//	let content:String
	...
	init(nama:String, nik:String, tanggalLahir:Date, alamat:String, Rt:String, Rw:String, kelurahan:String, kecamatan:String, kota:String, provinsi:String, pekerjaan:String, nomorHp:String) {
