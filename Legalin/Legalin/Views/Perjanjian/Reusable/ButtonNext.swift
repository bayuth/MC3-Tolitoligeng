        ...
        VStack{
            ...
            ZStack{
                RoundedRectangle(cornerRadius: 10)
                    .foregroundColor(perjanjianController.nextButtonState ?  Color(#colorLiteral(red: 0.06274509804, green: 0.2784313725, blue: 0.4117647059, alpha: 1)) : Color(#colorLiteral(red: 0.4392156863, green: 0.4392156863, blue: 0.4392156863, alpha: 1)))
